...
pararm_keys, param_combinations = config_compiler('DeepAR.yaml')

pararm_keys
df_results = pd.DataFrame(columns=['Parameters', 'Val RMSE', 'Val MAE', 'Test RMSE', 'Val MAE'])
temp_results = []

i = param_combinations[0]
year = i[0]
max_enc = i[1]
max_pred = i[2]
